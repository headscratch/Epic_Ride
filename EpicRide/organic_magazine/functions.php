...
function ot_enqueue_scripts() {	wp_enqueue_style( 'organic-shortcodes', get_template_directory_uri() . '/css/organic-shortcodes.css', array( 'organic-style' ), '1.0' );	wp_enqueue_style( 'organic-shortcodes-ie8', get_template_directory_uri() . '/css/organic-shortcodes-ie8.css', array( 'organic-shortcodes' ), '1.0' );	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/font-awesome.css', array( 'organic-shortcodes' ), '1.0' );	// IE Conditional Styles	global $wp_styles;	$wp_styles->add_data('organic-shortcodes-ie8', 'conditional', 'lt IE 9');
